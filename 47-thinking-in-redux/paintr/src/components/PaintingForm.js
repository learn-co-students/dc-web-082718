...
class PaintingForm extends React.Component {
  ...
  onSave = e => {
    ...
    //before: ("ry748ybr9823", {title:"", name:"", birthday:"", deathday:""})
    //after: ({paintingId: "ry748ybr9823", title:"", name:"", birthday:"", deathday:""})
    // alert("painting has been saved")
...
//   return{
//     updatePaintingInfo: (payload) => {dispatch(updatePaintingInfo(payload))}
//   }
// }
